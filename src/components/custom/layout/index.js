...
const Layout = ({ largeContent }) => {
  ...
  return (
    <>
      <div className={`${largeContent && 'remove'} animate-cont`}>
        <div className="animate">Open</div>
      </div>
      <div className={`${largeContent && 'remove'} custom-btn btn-layout`}>
      ...
      <div className="sidebar-cont">
        <Sidebar />
        <div className={`${largeContent && 'remove'} page`}>
